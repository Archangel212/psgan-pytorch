...
if __name__ == '__main__':
    ...
    # detail settings
    parser.add_argument('--zl_dim', type=int, default=10, help='size of local part noise dimension')   # set default same as author's implementation
    parser.add_argument('--zg_dim', type=int, default=0, help='size of global part noise dimension')  # set default same as author's implementation
    parser.add_argument('--zp_dim', type=int, default=2, help='size of periodic part noise dimension') # set default same as author's implementation
